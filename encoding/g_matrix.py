...
import numpy as np
from inv_maps_master.graph_generators.sierpinski import unfilled_sierpinski_with_children
from inv_maps_master.utils.encoding_graph_utils import G_matrix_from_graph, greedy_remove_edges
