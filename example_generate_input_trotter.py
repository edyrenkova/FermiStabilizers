...
lattice_size_arr = [4]
efficient_trotter_steps_arr = [1] #[1,2,3,4,5]
...
if not os.path.exists(FOLDER):
    os.makedirs(FOLDER)
filename = f'{FOLDER}/input_trotter.csv'
RAND_SEEDS_INPUT_FILE = FOLDER+'/input_trotter.csv'
...
generate_metadata(f'{FOLDER}/metadata_trotter.csv')
